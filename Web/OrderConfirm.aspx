<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MianForm.Master" AutoEventWireup="true" CodeBehind="OrderConfirm.aspx.cs" Inherits="BookShop.Web.OrderConfirm" %>
        ...
        <table datasrc="" style="width:100%" id="userinfo">
              <tbody>
                <tr>
                  ...
                  <td style="text-align:left"><input type="text" name="txtName" size="50" value="<%=UserModel.Name %>" /><img  src="images/cha.ico" style="display:none"  width="15" height="15" /></td>
                </tr>
                <tr>
                              <td  align="right">地址：</td>
                  <td style="text-align:left"><input type="text" name="txtAddress" size="50" value="<%=UserModel.Address %>" /><img  src="images/cha.ico" style="display:none"  width="15" height="15" /> </td>
                </tr>
                <tr>
                               <td  align="right">电话：</td>
                  <td style="text-align:left"><input type="text" name="txtPhone" size="50" value="<%=UserModel.Phone %>" /><img  src="images/cha.ico" style="display:none"  width="15" height="15" /></td>
                </tr>
                <tr>
