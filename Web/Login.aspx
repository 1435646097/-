            ...
            <div class="login_panel clearfix">
                <div class="reg_r po p65">
                    ...
                    <a href="javascript:void(0)">
                        <img src="/Picture/2019/9/23/3146920f-fcf5-48a0-8361-d3e4e6c60caf.jpg" alt="风景"></a>
                            ...
                            <form action="Login.aspx" method="post">
                                ...
                                <div class="rem_for wid100">
                                    <div class="fr" style="margin-right: 30px;">
                                        ...
                                        <label>
                                            <input id="chkRember" name="chkRember" type="checkbox" value="1">自动登录</label><a href="javascript:void(0)" id="btnForget">忘记密码?</a>
                                    </div>
                                </div>
